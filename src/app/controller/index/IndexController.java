...
public class IndexController {
	...
	public ModelAndView loginHandle(@RequestParam Map param, WebRequest wr) {
		ModelAndView mav = new ModelAndView();
		System.out.println("loginHandle entered..");
		System.out.println(param.get("pw").equals(ar.getPwById(param)));
		System.out.println(param.get("pw"));
		System.out.println(ar.getPwById(param));
		
		
		if(ar.getPwById(param)) {
			System.out.println("loginHandle id/pw passed..");
